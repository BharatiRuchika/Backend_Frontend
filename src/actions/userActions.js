...
export const updateProfile = (userData)=>async(dispatch)=>{
 ...
 const {data} = await axios.put("http://localhost:3000/auth/me/update",userData,config)
...
export const updatePassword = (passwords)=>async(dispatch)=>{
 ...
 const {data} = await axios.put("http://localhost:3000/auth/password/updatepassword",passwords,config)
 console.log("userdata",data);
 dispatch({
 ...
 const {data} = await axios.put(`http://localhost:3000/auth/password/reset/${token}`,passwords,config)
 console.log("userdata",data);
 dispatch({
 ...
 const {data} = await axios.post("http://localhost:3000/auth/password/forgot",email,config)
 console.log("userdata",data);
 dispatch({
...
const {data} = await axios.get("http://localhost:3000/auth/admin/users");
...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://localhost:3000/auth/admin/user/${id}`, userData, config)
...
export const getUserDetails = (id) => async (dispatch) => {
 ...
 const { data } = await axios.get(`http://localhost:3000/auth/admin/user/${id}`)
...
export const deleteUser = (id) => async (dispatch) => {
 ...
 dispatch({ type: DELETE_USER_REQUEST })
  const { data } = await axios.delete(`http://localhost:3000/auth/admin/user/${id}`);
